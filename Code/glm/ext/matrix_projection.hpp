...
namespace glm
{
	...
	///
	/// @param center Specify the origin of a picking region in window coordinates.
	/// @param delta Specify the camera_width and camera_height, respectively, of the picking region in window coordinates.
